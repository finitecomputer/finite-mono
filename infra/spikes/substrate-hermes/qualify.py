...
subprocess.run(base+['suspend','actor','alice-agent','-a','finite-hermes-spike'],check=True,timeout=180)
suspend_s=time.monotonic()-started
state=subprocess.check_output(base+['get','actor','alice-agent','-a','finite-hermes-spike','-o','json'],text=True)
