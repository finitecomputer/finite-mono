...
| `finite-sites` | `sites.Dockerfile` (context: repo root; Rust pin from `rust-toolchain.toml`) | `service-images.yml` (`sites`) | [Sites deployment](../runbooks/deploy-sites.md#fly); isolated deployment pending production cutover. |
