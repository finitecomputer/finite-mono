...
| `finite-sites` | `sites.Dockerfile` (context: repo root; Rust pin from `rust-toolchain.toml`) | `service-images.yml` (`sites`) | [Sites on Fly](../fly/sites/README.md); isolated deployment pending production cutover. |
