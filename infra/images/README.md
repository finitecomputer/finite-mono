...
| `laguna-s21-vllm` | `laguna-s21-vllm.Dockerfile` (measured vLLM 0.25.1 runtime, four TP2 replicas plus least-active streaming router) | Not yet wired; candidate only | Prepared Finite Private Laguna S 2.1 FP8 candidate; requires tokenizer-corrected target MPK, draft MPK, image workflow, digest pin, and explicit rollout approval |
