...
**quiesced SQLite copy** of `/var/lib/finite-chat/data/server.sqlite3`
(stop the service or checkpoint WAL first) **plus a DNS flip** of
`chat.finite.computer` from 15.204.108.57 to 64.34.82.77. It is explicitly
NOT part of routine deploys and NOT part of the migration-integration PR
