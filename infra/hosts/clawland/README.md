...
specialization request worker (in staged retirement: Runner and agentd no
longer hand the bundle to new or upgraded runtimes; the worker stays up
until the live HTTP image-request counter is flat) and the narrow
`finite.vip` NIP-05 path proxy.
