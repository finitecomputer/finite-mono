  ...
  assertions = [
    {
      ...
      message = "finite-lat-5 root A disk identity drifted";
    }
    {
      assertion = disks."root-b".device == ids.disks.rootB;
      message = "finite-lat-5 root B disk identity drifted";
    }
    {
      assertion = disks."data-a".device == ids.disks.dataA;
      message = "finite-lat-5 data A disk identity drifted";
    }
    {
      assertion = disks."data-b".device == ids.disks.dataB;
      message = "finite-lat-5 data B disk identity drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-5 ESP geometry drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-5 root member geometry drifted";
    }
    {
      assertion =
        dataA."data-a".start == "2048s"
        && dataA."data-a".end == "14990450687s"
        && dataB."data-b".start == "2048s"
        && dataB."data-b".end == "14990450687s";
      message = "finite-lat-5 data member geometry drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-5 root MD creation contract drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-5 data MD creation contract drifted";
    }
    {
      assertion = arrays.root.metadata == "1.2" && arrays.data.metadata == "1.2";
      message = "finite-lat-5 MD metadata version drifted";
    }
    {
      assertion =
        lib.length (lib.unique (lib.attrValues ids.partuuids)) == 6
        && lib.length (lib.unique (lib.attrValues ids.filesystemUuids)) == 4;
      message = "finite-lat-5 partition or filesystem identifiers are not unique";
    }
    {
      assertion =
        map (swap: {
      ...
      message = "finite-lat-5 swap contract drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-5 zswap contract drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-5 mirrored ESP paths drifted";
    }
  ];
}
