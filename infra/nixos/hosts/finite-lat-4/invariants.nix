  ...
  assertions = [
    {
      ...
      message = "finite-lat-4 root A disk identity drifted";
    }
    {
      assertion = disks."root-b".device == ids.disks.rootB;
      message = "finite-lat-4 root B disk identity drifted";
    }
    {
      assertion = disks."data-a".device == ids.disks.dataA;
      message = "finite-lat-4 data A disk identity drifted";
    }
    {
      assertion = disks."data-b".device == ids.disks.dataB;
      message = "finite-lat-4 data B disk identity drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 ESP geometry drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 root member geometry drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 data member geometry drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 root MD creation contract drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 data MD creation contract drifted";
    }
    {
      assertion = arrays.root.metadata == "1.2" && arrays.data.metadata == "1.2";
      message = "finite-lat-4 MD metadata version drifted";
    }
    {
      assertion =
        lib.length (lib.unique (lib.attrValues ids.partuuids)) == 6
        && lib.length (lib.unique (lib.attrValues ids.filesystemUuids)) == 4;
      message = "finite-lat-4 partition or filesystem identifiers are not unique";
    }
    {
      assertion =
        map (swap: {
      ...
      message = "finite-lat-4 swap contract drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 zswap contract drifted";
    }
    {
      assertion =
      ...
      message = "finite-lat-4 mirrored ESP paths drifted";
    }
  ];
}
