...
pub struct CliEnvironment {
    ...
    /// Transport URL supplied by the Runtime contract. The process
    /// environment falls back to FiniteBrain's canonical production origin;
    /// injected test and embedded environments may leave it unset.
    pub server_url: Option<String>,
    /// Optional browser-visible origin used for signed HTTP authorization when
    /// it differs from the transport URL.
