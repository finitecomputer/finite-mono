...
const PRODUCT_CLIENT_APP_SCRIPT_TAG: &str =
    r#"<script src="/client/app.js?v=20260725-backlinks"></script>"#;
...
pub(crate) async fn product_client_handler(State(state): State<ServerState>) -> impl IntoResponse {
    ...
    <script src="/client/app.js?v=20260725-backlinks"></script>
    <script src="/client/smoke-nip07.js?v=20260725-backlinks"></script>"#,
        );
    }
