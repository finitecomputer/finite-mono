...
assert.match(htmlSource, /id="sessionAccountVaultButton"[^>]*aria-haspopup="dialog"/);
assert.match(source, /sessionAccountVaultButton[\s\S]{0,180}openSettingsModal\("vault"\)/);
