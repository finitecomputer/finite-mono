...
invited email, Brain, authorized Folder scope, Folder key versions, Invite
...
authenticated recipient npub, authorized Brain/Folder/key-version scope,
...
that binds the claim to the invite code, Brain, invited email, claimant npub,
...
bootstrap or become a Brain Member from that invite.
...
Email-targeted Brain Invitations include current all-members Folders in the
bootstrap scope automatically, because a successful claim makes the recipient a
Brain Member and existing Brain semantics require all Brain Members and admins
...
not unlock the Git repository; Brain invite metadata can reveal private Brain
...
they must not include invited email, Brain or Folder names/ids, access scope,
...
agent, including human-readable Brain and Folder names. Names are allowed after
...
In v1, Brain owns product-specific Brain invite delivery while finite-identity
...
Brain invitation content or access policy.
...
payload. Brain may keep minimal audit metadata such as invite id, Brain id,
