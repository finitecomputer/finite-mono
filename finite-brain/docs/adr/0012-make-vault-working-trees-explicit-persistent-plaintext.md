# Make Vault Working Trees Explicit Persistent Plaintext

Status: accepted

A Vault Working Tree is an explicitly created durable plaintext projection,
...
ephemeral by default unless the controller separately chooses to create a Vault
Working Tree.
