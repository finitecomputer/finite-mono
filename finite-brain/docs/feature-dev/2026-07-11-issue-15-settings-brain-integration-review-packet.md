...
The old Brain selector/control strip is gone from the file sidebar, and its
legacy handlers now tolerate the removed nodes. Settings owns Session, Brain,
...
- Browser: rebuilt Rust Product Client loaded at `http://127.0.0.1:3015/client`; Settings, Brain switcher, Access mount, Invitations mount present; Access panel absent from file sidebar; no console errors observed
