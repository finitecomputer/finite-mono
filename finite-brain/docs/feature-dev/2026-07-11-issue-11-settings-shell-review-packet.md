...
- Slice type: AFK
- Acceptance criteria: compact footer identity/settings row; accessible Session/Brain Settings modal; existing Session Lock/Resume/signer behavior; no regression to Files/Search; responsive no-overflow foundation
- Baseline: `9408651`
- Current diff: `9408651...644e981`

## Implementation Summary

The Product Client now has a compact bottom account/Brain row and a Settings
modal with Session and Brain sections. Session Lock, Resume, signer connection,
...
- Green implementation, if applicable: corrected dialog semantics and explicit interim Brain Settings action
...
SPEC_FINDINGS:
- The final Access-sidebar migration is intentionally deferred to #13; the interim Brain footer action is functional and explicitly opens Brain Settings until #12 supplies the switcher.
```
