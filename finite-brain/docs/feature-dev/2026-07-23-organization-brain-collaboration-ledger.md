...
- Started: 2026-07-23
- Current status: ticket 217 implementation
...
| --- | --- | --- | --- | --- | --- |
| #217 | server + CLI tracer | ready-for-agent | pending | pending | no |
...
| --- | --- | --- | --- | --- | --- |
| pending | `e6077bfd9dc87882735898b87246a6650119c67a` | pending | pending | pending | pending |
