# Guided Smoke Vault Reader Ledger
...
- Product decision: the Product Client should show a guided Vault Reader before raw crypto/write controls.
- Recommended behavior: after signer connection, the user should be able to load a Vault, auto-open available development Folder Key Grants, pull/decrypt accessible Pages, click folders, click pages, and read content.
