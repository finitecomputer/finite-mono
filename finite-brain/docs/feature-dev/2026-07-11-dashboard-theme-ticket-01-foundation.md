...
- [ ] The base shell, ribbon, Vault controls, Session Lock, toolbars, buttons, fields, selects, checkboxes, focus states, disabled states, and locked workspace use the new visual language.
