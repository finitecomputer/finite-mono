...
use finitesites_proto::dto::{
    ...
    ProjectInitRequest, ProjectInitResponse, ProjectRevokeRequest, ProjectRevokeResponse,
    ProjectSiteSharingResponse, ProjectSiteSummary, ProjectStatusResponse, SharingRequest,
...
impl TestServer {
    ...
    /// gate does after account-session authentication. Each call uses
