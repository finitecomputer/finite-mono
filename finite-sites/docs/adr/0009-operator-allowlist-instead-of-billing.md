...
Superseded for ongoing product design by ADR-0016 and ADR-0020. The operator
command surface remains as a manual override/revocation lever, but it writes
`operator` rows into the publish grant cache instead of being the default
authorization model.
