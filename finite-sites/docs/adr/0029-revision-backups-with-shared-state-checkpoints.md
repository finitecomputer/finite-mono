...
up changed project revisions to S3 independently. Registry and service-secret
...
S3 access and decryption-key recovery remain independent of the serving host.
