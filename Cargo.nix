...
rec {
  ...
  workspaceMembers = {
    ...
    "source-structure" = rec {
      packageId = "source-structure";
      build = internal.buildRustCrateWithFeatures {
        packageId = "source-structure";
      };
  ...
  internal = rec {
    ...
    crates = {
      ...
      "source-structure" = rec {
        ...
        src = lib.cleanSourceWith { filter = sourceFilter;  src = ./tools/source-structure; };
        libName = "source_structure";
        dependencies = [
          {
            name = "anyhow";
            packageId = "anyhow";
