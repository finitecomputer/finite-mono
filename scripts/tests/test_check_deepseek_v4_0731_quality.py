...
from scripts.check_deepseek_v4_0731_quality import CASES, _payload, _score


class DeepSeekV40731QualityTests(unittest.TestCase):
    def test_self_hosted_payload_explicitly_requests_official_sampling_and_thinking(self) -> None:
        payload = _payload(
            CASES[0],
    ...
    def test_hosted_payload_uses_the_native_reasoning_contract(self) -> None:
        payload = _payload(
            CASES[0],
