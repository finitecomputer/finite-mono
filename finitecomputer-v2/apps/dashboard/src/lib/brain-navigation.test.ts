...
test("Brain navigation exposes the prototype only in design preview mode", async () => {
  ...
  assert.match(item, /href: dashboardDesignPreviewEnabled \? `\$\{root\}\/brain` : undefined/u);
