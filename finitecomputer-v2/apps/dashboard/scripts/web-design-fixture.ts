...
function coreMe() {
  return {
    ...
    projects: [{
      ...
      runtime: { ...(process.env.FC_WEB_DESIGN_NATIVE_HERMES === "1" ? { native_hermes_chat: true } : {}), id: RUNTIME_ID, project_id: "project_web_design", contact_endpoint: `http://127.0.0.1:${hostedPort}/runtime-status`, runtime_status: "online", hermes_available: true, created_at: "2026-07-01T12:00:00Z", updated_at: "2026-07-01T12:00:00Z" },
