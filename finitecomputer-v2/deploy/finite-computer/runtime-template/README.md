...
- Hermes Agent 0.20.0 (v2026.8.3; installed from the pinned GitHub source tarball — the PyPI channel was retired upstream in this release) in `/runtime/hermes-venv`
